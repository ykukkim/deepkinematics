"""Evaluate saved joint-centre or forward-kinematics reconstruction models."""
...
if __name__ == '__main__':
    ...
    p.add_argument('--experimentid', type=str, default="BIRNN")
    ...
    p.add_argument('--subject', default=['04','09','14','24','51','54','67','81'], type=int, help='Chose subject to visualize.')
    #['04','09','14','24','51','54','67','81']
    p.add_argument('--save_matlab', action='store_true', help='Save kinematic data to matlab struct')
    p.add_argument('--save_metrics_excel', action='store_false', help='Save mean & std of euclidean distance per joint')
    p.add_argument('--visualize', action='store_true', help='Visualize subject trial.')
